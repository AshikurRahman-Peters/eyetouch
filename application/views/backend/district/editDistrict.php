            ...
            <div class="card-body">
                <div class=" col-md-12">
                    ...
                    <form id="formGallery" method="post"
                        action="<?php echo base_url() ?>update_district/<?php echo $district->district_id ?>">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="district_name" id="district_name" class="form-control"
                                    placeholder="Name" autocomplete="off" value="<?php $district->district_name ?>">
                                <!-- <?php //form_error('district_name', '<span style="color: #ff0002">', '</span>'); ?> -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="charge" id="charge" class="form-control" placeholder="charge"
                                    autocomplete="off" value="<?= $district->charge ?>">

<div class="home-element">
    ...
    <div class="row">
        <div class="col-xl-4 col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <?php $offer_two=$this->db->query("SELECT * FROM tbl_featured WHERE status = 1 and  type = 'FEATURE_ITEMS'")->row(); 
        ...
        <?php
       $AllProductData = $this->db->query("select * from tbl_products where pro_status = 1 and 	future_product = 'FEATURE_ITEMS'")->result();

...
(function (root, factory) {
  ...
  (function ($) {
    ...
    Selectpicker.DEFAULTS = {
      noneSelectedText: "Select Items Here",
        ...
        var actionsbox =
          this.multiple && this.options.actionsBox
            ? '<div class="bs-actionsbox">' +
              '<div class="btn-outline-group btn-outline-group-sm btn-outline-block">' +
              '<button type="button" class="actions-btn bs-select-all btn btn-outline-default">' +
              this.options.selectAllText +
              "</button>" +
              '<button type="button" class="actions-btn bs-deselect-all btn btn-outline-default">' +
        ...
        var donebutton =
          this.multiple && this.options.doneButton
            ? '<div class="bs-donebutton">' +
              '<div class="btn-outline-group btn-outline-block">' +
              '<button type="button" class="btn btn-outline-sm btn-outline-default">' +
            ...
            : "";
        var drop =
          '<div class="btn-outline-group bootstrap-select' +
          showTick +
          inputGroup +
          '">' +

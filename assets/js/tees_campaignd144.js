...
window.onload = function () {
  if (window.jQuery) {
    ...
    var customSearchbox = instantsearch.connectors.connectSearchBox(function (
      ...
      if (isFirstRender) {
        document.querySelector(widgetParams.container).innerHTML =
          ...
          '<input type="search" value="" autocomplete="off" class="form-control" id="q" placeholder="' +
    ...
    //with gp merchendise include
    search.addWidget(
      instantsearch.widgets.configure({
        filters:
          "status:1 AND NOT isSearchable:0 AND NOT type:men AND NOT type:kids AND NOT type:women AND NOT type:'full sleeve' AND NOT type:sweatshirt",
      })
    );

    //with gp merchendise exclude
    // search.addWidget(
    // 	instantsearch.widgets.configure({
    // 		filters: "status:1 AND NOT isSearchable:0 AND NOT type:men AND NOT type:kids AND NOT type:women AND NOT type:'full sleeve' AND NOT type:sweatshirt AND NOT tags:gpmerchandise"
    // 	})
    // );
    ...
    typeSorting["blank t-shirt for men"] = typeSorting_cnt++;
    typeSorting["mens polo t-shirt"] = typeSorting_cnt++;
    typeSorting["mens shirts"] = typeSorting_cnt++;
    typeSorting["panjabi"] = typeSorting_cnt++;
    typeSorting["tupi"] = typeSorting_cnt++;
    ...
    typeSorting["mens jacket"] = typeSorting_cnt++;
    typeSorting["mens joggers"] = typeSorting_cnt++;
    typeSorting["men's premium t-shirt combo"] = typeSorting_cnt++;
    typeSorting["mens jeans"] = typeSorting_cnt++;
    typeSorting["trouser"] = typeSorting_cnt++;
    typeSorting["mens shorts"] = typeSorting_cnt++;
    typeSorting["underwear"] = typeSorting_cnt++;
    typeSorting["socks"] = typeSorting_cnt++;
    typeSorting["mens sports trouser"] = typeSorting_cnt++;
    typeSorting["sports t-shirt"] = typeSorting_cnt++;
    typeSorting["football jersey"] = typeSorting_cnt++;
    typeSorting["kurti"] = typeSorting_cnt++;
    typeSorting["womens t-shirts"] = typeSorting_cnt++;
    typeSorting["womens trouser"] = typeSorting_cnt++;
    typeSorting["kids polo t-shirt"] = typeSorting_cnt++;
    typeSorting["kids short sleeve"] = typeSorting_cnt++;
    typeSorting["kids premium maggie"] = typeSorting_cnt++;
    typeSorting["kids full sleeve"] = typeSorting_cnt++;
    typeSorting["blank t-shirt for kids"] = typeSorting_cnt++;
    typeSorting["shorts for kids"] = typeSorting_cnt++;
    ...
    var typeGrouping = [];
    typeGrouping["flash sale"] = "mens";
    typeGrouping["mens shirts"] = "mens";
    typeGrouping["panjai"] = "mens";
    typeGrouping["tupi"] = "mens";
    typeGrouping["mens polo t-shirt"] = "mens";
    typeGrouping["flash sale (full sleeve)"] = "mens";
    typeGrouping["flash sale (sweatshirt)"] = "mens";
    typeGrouping["flash sale (hoodie)"] = "mens";
    typeGrouping["mens jacket"] = "mens";
    typeGrouping["mens joggers"] = "mens";
    typeGrouping["mens jeans"] = "mens";
    typeGrouping["trouser"] = "mens";
    typeGrouping["mens shorts"] = "mens";
    typeGrouping["underwear"] = "mens";
    typeGrouping["socks"] = "mens";
    typeGrouping["men's premium t-shirt combo"] = "mens";
    typeGrouping["mens sports trouser"] = "sports";
    typeGrouping["sports t-shirt"] = "sports";
    typeGrouping["football jersey"] = "sports";
    typeGrouping["kurti"] = "womens";
    typeGrouping["womens t-shirts"] = "womens";
    typeGrouping["womens trouser"] = "womens";
    typeGrouping["kids polo t-shirt"] = "kids";
    typeGrouping["kids short sleeve"] = "kids";
    typeGrouping["kids premium maggie"] = "kids";
    typeGrouping["kids full sleeve"] = "kids";
    typeGrouping["kids t-shirt combo"] = "kids";
    typeGrouping["kids summer t-shirt combo"] = "kids";
    typeGrouping["kids pant combo"] = "kids";
    typeGrouping["kids t-shirt with shorts combo"] = "kids";
    typeGrouping["kids trouser"] = "kids";
        ...
        transformItems: function (items) {
          ...
          return items.map(function (item) {
            ...
            var catIdToName = {
              ...
              "kids premium maggie": "Maggie Tees",
              "men's premium t-shirt combo": "Unisex Tees",
              "womens t-shirts": "Short Sleeve T-shirt",
              trouser: "Trouser & Pajamas",
              "mens sports trouser": "Sports Trouser",
              "womens trouser": "Comfy Trouser",
              ...
              "flash sale": "Short Sleeve T-shirt",
              "flash sale (full sleeve)": "Full Sleeve T-shirt",
              "flash sale (sweatshirt)": "Sweatshirt",
              "flash sale (hoodie)": "Hoodie",
              "mens jacket": "Jacket",
              "blank t-shirt for kids": "Plain T-shirt",
              "blank t-shirt for men": "Plain T-shirt",
              "shorts for kids": "Shorts",
              "mens polo t-shirt": "Polo T-shirt",
              "football jersey": "Football Jersey",
              "sports t-shirt": "Sports T-shirt",
              "kids polo t-shirt": "Polo T-shirt",
              "mens joggers": "Joggers",
              "mens shorts": "Shorts",
              "kids full sleeve": "Full Sleeve T-shirt",
              "kids short sleeve": "Short Sleeve T-shirt",
              "kids trouser": "Trouser",
              "mens shirts": "Shirt",
              kurti: "Kurti, Tunic & Tops",
              "mens jeans": "Denim Jeans",
              tupi: "Tupi",
              20: "Music",
              30: "Occasion",
              28: "Passion",
              ...
              49: "Mens Jacket",
              50: "Shorts",
              51: "Short Sleeve T-shirt",
              52: "Underwear",
              53: "Womens T-shrit",
              54: "Kids Polo T-shirt",
              55: "Socks",
              56: "Joggers",
              57: "Mens Shirt",
              58: "Panjabi",
    ...
    var campaignList = instantsearch.widgets.panel({
      templates: {
        header: "",
      },
    })(instantsearch.widgets.refinementList);
